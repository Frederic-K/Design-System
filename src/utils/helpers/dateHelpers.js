 ...
 * @returns {boolean} - Vrai si le niveau est valide, faux sinon.
 */
 ...
 * @returns {string} - La couleur correspondant au niveau de log.
 */
 ...
 * @param {any} details - Les détails de l'erreur.
 * @returns {object} - La réponse d'erreur standardisée.
 */
 ...
 * @returns {object} - La réponse de succès standardisée.
 */
 ...
 * @param {number} baseDelay - Le délai de base pour le backoff.
 * @returns {Promise<any>} - Une promesse résolue par la fonction réussie.
 */
 ...
 * @param {string} key - La clé par laquelle grouper.
 * @returns {object} - Les éléments groupés par clé.
 */
 ...
 * @returns {boolean} - Vrai si la chaîne est un JSON valide, faux sinon.
 */
