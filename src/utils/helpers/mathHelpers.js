 ...
 * @returns {number} - The percentage value rounded to 2 decimal places.
 */
...
// // Calculate the percentage of a part relative to a total, with a specified decimal places.
// export function calculatePercentage(part, total, decimalPlaces = 2) {
//   if (total === 0) return 0;
 ...
 * @returns {object} - An object containing min, max, avg, sum, and count.
 */
